...
class BaseAI(Action, BaseComponent):
    ...
    def get_path_to(self, dest_x: int, dest_y: int) -> List[Tuple[int, int]]:
        ...
        # In the case of our simple game, all parts of the map have the same cost,
        # but what this cost array allows us to do is take other entities into account.
        ...
        # compute path and remove the starting point
